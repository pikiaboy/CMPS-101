...
public class List{
  ...
  public int front(){ // Returns front element. Pre: length()>0
    return front.data;
  }
  public int back(){ // Returns back element. Pre: length()>0
    return back.data;
  }

  public int get(){ // Returns cursor element. Pre: length()>0, index()>=0
    return cursor.data;
  }
  ...
  // undefined, if cursor is undefined does nothing.
    if(cursor != null && index != 0){
      ...
      cursor = null;
      index = -1;
    } else if(cursor == null){}//do nothing
  }
  ...
  public void prepend(int data){ // Insert new element into this List. If List is non-empty,
  ...
  public void append(int data){ // Insert new element into this List. If List is non-empty,
  ...
  public void insertBefore(int data){ // Insert new element before cursor.
  ...
  public void insertAfter(int data){ // Inserts new element after cursor.
   // Pre: length()>0, index()>=
   Node newNode = new Node(data);
